...
public:
    ...
    virtual MATRIX3 Jacobian(const VECTOR3& pos, float delta=0.1f);
    virtual MATRIX3 UnitJacobianStructuredGrid(const int i, const int j, const int k, bool bNormalize=false) ;
