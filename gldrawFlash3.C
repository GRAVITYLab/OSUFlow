...
void animate_streamlines() {
  ...
  for (int i=0; i<npart; i++) {
	...
	//	if (cnt%num_frames == current_frame) { 
...
void draw_vector(int i) 
{
  ...
  glColor3f(0,0,1); 
  printf(" %f %f %f ", vectors[i][0], vectors[i][1], vectors[i][2]); 
...
main(int argc, char* argv[]) 
{
  ...
  latticeAMR->CompleteLevels(1); // this call is very important. It finishes up all the 
