...
gcbPoints:
The is a demo to show how to render the particles generated from flow field.
...
void compute_streamlines() 
{
  ...
  cPointRenderer._Update();
}

void draw_points() 
{
	cPointRenderer._Draw();
}
...
_KeyboardFunc(unsigned char ubKey, int iX, int iY)
{
	...
	case 'n':
		cPointRenderer._UpdateTraceMode();
		glutPostRedisplay();
		break;
	
	case 'm':
		cPointRenderer._UpdateSelectedTrace();
		glutPostRedisplay();
		break;
...
main(int argn, char* argv[])
{
	...
	///////////////////////////////////////////////////////////////
	cPointRenderer._SetBoundingBox(
		minLen[0], minLen[1], minLen[2], 
		maxLen[0], maxLen[1], maxLen[2]);
	cPointRenderer._SetDataSource(&sl_list);
	
	///////////////////////////////////////////////////////////////
	glutCreateWindow("GCB Points");
...
Revision 1.1  2010/04/19 16:41:53  chaudhua
*** empty log message ***
